...
public class PokemonResource {
    ...
    public Response save(@Valid PokemonTO cliente) {
        PokemonTO resultado = pokemonBO.save(cliente);
        Response.ResponseBuilder response = null;
        if (resultado != null){
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Path("/{codigo}")
    public Response update(@Valid PokemonTO cliente, @PathParam("codigo") Long codigo) {
        cliente.setCodigo(codigo);
        PokemonTO resultado = pokemonBO.update(cliente);
        Response.ResponseBuilder response = null;
